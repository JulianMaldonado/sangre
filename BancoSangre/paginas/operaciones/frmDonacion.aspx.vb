...
#Region "Metodos Directo"
    ...
    Public Function fGuardar() As Integer
        ...
        Try
           If clsComunes.Respuesta_Operacion.Guardado = acceso.fInsertarDonacion(1, Session("idusuario"), txtNombre.Text, txtNit.Text,"ACTIVO"  ) Then
    ...
    Public Sub fllenarGrid()
        ...
        Try
            ...
            dt = acceso.fListarDetalleDonacion(Session("id_empleado"))
            stDG.DataSource = dt
            stDG.DataBind()
