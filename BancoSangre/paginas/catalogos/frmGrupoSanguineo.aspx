                    ...
                    <TopBar>
                        <ext:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <ext:TextField runat="server" ID="txtGrupoSanguineo" Regex="[a-zA-Z]" AllowBlank="false"></ext:TextField>
                                <ext:Button ID="btnGuardarGrupoSanguineo" runat="server" Width="160" Text="Guardar Nueva" Icon="Add">
                                    <Listeners>
