...
Public Module Funciones
    ...
    Public Function _NITvalido(ByVal Nit As String) As Boolean
        ...
        End If
    End Function
    Function _CONSULTAR_SQL(ByVal query As String, ByVal q As String) As OracleDataReader
        Dim bd As New clsGestorBaseDatos
        bd.fAbrir()
        bd._Cmd.CommandText = query
        Dim r As OracleDataReader = bd._Cmd.ExecuteReader()
        Return r
    End Function
    ...
    Function _CONSULTAR_SQL(ByVal query As String) As DataTable
        Dim bd As New clsGestorBaseDatos
    ...
    Function _EJECUTAR_SQL(ByVal query As String) As Integer
        Try
            Dim bd As New clsGestorBaseDatos
            bd._Cmd = New OracleCommand(query, bd.ObtenerConexion())
